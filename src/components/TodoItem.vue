...
<template>
  <li
    class="bg-stone-200 hover:bg-stone-300 border-2 border-stone-300 w-full rounded-md flex items-center p-2 m-2"
  >
    <div>
      <button
    ...
    <span :class="{ 'line-through opacity-25': props.todo.isDone }" class="text-lg w-full mx-4">{{
      props.todo.text
    }}</span>
    <div class="mt-10">
      <button
